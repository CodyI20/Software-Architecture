...
public class EnemySpawnerSettingsSO : ScriptableObject
{
    ...
    [Tooltip("The interval of time after each enemy in the wave will spawn"), Min(0.1f)] public float spawnInterval = 1f;
    [Tooltip("The amount of time from the wave pop-up until it starts"), Min(1f)] public float timeUntilWaveStarts = 10f;
}
